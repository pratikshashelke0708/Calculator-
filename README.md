...
2. Styling:
Clean, organized layout with buttons for numbers and operations.
Clear display area for showing input and result.
Optional colors or highlighting for better readability of buttons and operations.

3. Logic:
User inputs a number → store it temporarily.
User selects an operation → store operation type.
User inputs second number → store it.
...
DOM Manipulation: To update display dynamically in web version
